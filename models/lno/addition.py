...
class NystromAttention(nn.Module):
    ...
    def forward(self, x, mask = None, return_attn = False):
        ...
        if remainder > 0:
            ...
            if exists(mask):
                mask = F.pad(mask, (padding, 0), value = False) # type: ignore
        ...
        if exists(mask):
            ...
            q, k, v = map(lambda t: t * mask[..., None], (q, k, v)) # type: ignore
        ...
        if exists(mask):
            ...
            divisor = mask_landmarks_sum[..., None] + eps # type: ignore
            mask_landmarks = mask_landmarks_sum > 0 # type: ignore
        ...
        if exists(mask):
            ...
            sim1.masked_fill_(~(mask[..., None] * mask_landmarks[..., None, :]), mask_value) # type: ignore
            sim2.masked_fill_(~(mask_landmarks[..., None] * mask_landmarks[..., None, :]), mask_value)
            sim3.masked_fill_(~(mask_landmarks[..., None] * mask[..., None, :]), mask_value) # type: ignore
